...
class _ViewMyProfileState extends State<ViewMyProfile> {
  ...
  shareToManager() async {
    final result = "*" +
        ...
        "\n" +
        calculateAge(profileDetail['birth_date_time']) +
        " years\nProfile id - " +
  ...
  profileRequest() async {
    ...
    if (responseData['success']) {
      ...
      imagesArray.add(profileDetail['photo'].toString().contains("member-photo")
          ? (imageUrlPrefix() + profileDetail['photo'].toString())
          : profileDetail['photo']);
      print(profileDetail["photo"] + "-----------------------------photo");
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          TitleText("Family type", profileDetail['family_type']),
          SizedBox(height: 10),
